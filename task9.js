...
function addOperation(newOperation) {
    if (document.getElementById('firstNum').innerHTML.length == 0 || document.getElementById('firstNum').innerHTML.substring(document.getElementById('firstNum').innerHTML.length - 1) == ' ')
